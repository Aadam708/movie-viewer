...
export default function Animation() {
  ...
  // Fetch animation movies from the API
  useEffect(() => {
  ...
  // Load reviews from local storage when a new movie is selected
  useEffect(() => {
    if (currentMovie) {
  ...
  // Open the modal and set the current movie
  ...
  // Render the appropriate number of stars based on the rating
